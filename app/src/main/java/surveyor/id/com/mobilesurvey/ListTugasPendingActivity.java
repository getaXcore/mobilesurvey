...
public class ListTugasPendingActivity extends AppCompatActivity implements GoogleApiClient.
    ...
    private static final String TAG = ListTugasPendingActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_tugas_pending);
        final Toolbar toolbar = (Toolbar) findViewById(R.id.my_awesome_toolbar);
        toolbar.setTitle("Tugas Pending");
    ...
    private void callListVolley(final String lat, final String lng) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if(resError > 3){
                            ...
                            Toast.makeText(ListTugasPendingActivity.this,"Gagal mengupdate data",Toast.LENGTH_LONG).show();
                            itemList.clear();
                            adapter.notifyDataSetChanged();
                            ArrayList<ArrayList<Object>> data_list = dm.ambilBarisJson("List Pending");
                            if (data_list.size() > 0) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ListTugasPendingActivity.this);
    ...
    private void getMyLocation() {
        try {
            ...
            if (mLastLocation != null) {
                ...
                Toast.makeText(ListTugasPendingActivity.this,
                        "mLastLocation == null" + mLastLocation,
